...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Sohom Chatterjee",
    description: `AI/ML Developer specializing in machine learning, deep learning, and data science.`,
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      window.scrollTo(0, 0);
    }, 4000); // Increased from 2000ms to 4000ms for a slower loading animation
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.sohomchatterjee.com${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.sohomchatterjee.com${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Sohom Chatterjee" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Sohom Chatterjee" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">sohom</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Sohom Chatterjee. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
