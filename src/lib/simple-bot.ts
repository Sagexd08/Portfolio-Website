// Simple chatbot with no external API dependencies
...
// Function to detect intent using regex patterns
function detectIntent(prompt: string): string {
  const lowerPrompt = prompt.toLowerCase();
  
  // Check for specific intents with multiple patterns for better matching
